...
const Knowledge_base_Categories = () => {
    ...
    return (
        <div>
            <PageHeader title="Categories (Knowledge base)" buttons={[{ label: "Add category", icon: FiPlusCircle, onClick: () => setIsDialogOpen(true) }]} />
                                        ...
                                        (col) =>
                                            visibleColumns[col.key] ? (
                                                <td key={col.key} className="px-6 py-4 text-sm">
                                                    {col.key === "status" ? (
                                                        <span
                                                            className={`px-3 py-1 rounded-lg text-white text-xs font-bold ${category.status.toLowerCase() === "active" ? "bg-green-500" : "bg-red-500"
                                                                }`}
                                                        >
                                                            {category.status}
                                                        </span>
...
export default Knowledge_base_Categories